  ...
  <div class="share-video-container" ref="containerRef">
    ...
    <div v-show="isConnected" class="fab-container" :style="fabStyle">
      ...
      <div class="fab-menu" :class="{ 'show': showFabMenu, 'align-left': isFabOnLeft, 'align-top': isFabOnTop }">
        ...
        <button class="fab-item" :disabled="!localSettings.audio && forbidAudio" @click="togglePageMute">
...
function createConnection() {
  ...
  inst.setAudioMuted(!soundOn.value)
...
function enableSound() {
  ...
  soundOn.value = true
  webrtc.value?.setAudioMuted(false)
  if (videoEl.value) {
...
function togglePageMute() {
  ...
  if (soundOn.value) {
    soundOn.value = false
    webrtc.value?.setAudioMuted(true)
