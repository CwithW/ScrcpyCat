...
public class ScreenCapture extends SurfaceCapture {
    ...
    public void start(Surface surface) throws IOException {
        ...
        try {
            // Make apps happy, do not make the VirtualDisplay's name "scrcpy".
            virtualDisplay = ServiceManager.getDisplayManager()
                    .createVirtualDisplay("Built-in Screen", inputSize.getWidth(), inputSize.getHeight(), displayId, surface);
