...
public final class ControlMessage {
    ...
    // ScrcpyCat extensions for WebRTC congestion and loss recovery.
    public static final int TYPE_SET_VIDEO_BITRATE = 23;
    public static final int TYPE_REQUEST_KEYFRAME = 24;
    ...
    public static ControlMessage createVideoBitrate(int bitrate) {
